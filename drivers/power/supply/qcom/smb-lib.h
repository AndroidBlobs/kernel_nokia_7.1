...
struct smb_charger {
	...
	int			*fih_dump_mask; // FIHTDC, IdaChiang, add for debug log
	int			fih_update_fun;// FIHTDC, IdaChiang
	int			fih_pre_cap;// FIHTDC, IdaChiang
	int			fih_pre_temp;// FIHTDC, IdaChiang
	bool			fih_check_chg_st; //FIHTDC, IdaChiang
	int			fih_pre_fv; // FIHTDC, IdaChiang
	int			sys_pre_temp;
	int			sys_ignore_temp_sts; // ignore temp
	int			fih_dcp_2a_enable; // DRG DCP 5V2A

	int			fih_hvdcp_current_ua; /* sharp set hvdcp to 1.5A */
