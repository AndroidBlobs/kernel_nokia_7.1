...
#include <linux/reboot.h>  // FIHTDC, IdaChiang, add for rradc error
...
int read_fail_cnt =0; // FIHTDC, IdaChiang, add for rradc error
...
// FIHTDC, IdaChiang, add for rradc error issue {{
...
int smblib_post_init(struct smb_charger *chg)
{
	...
	smblib_set_sw_jeita_comp(chg); // FIHTDC, IdaChiang, add for SW jeita
